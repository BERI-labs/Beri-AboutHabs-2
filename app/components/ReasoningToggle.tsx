...
export function ReasoningToggle({
  ...
  return (
    <button
      ...
      `}
      style={{
        borderColor: enabled ? "var(--beri-accent)" : "var(--beri-border)",
        background: enabled ? "var(--beri-accent-light)" : "transparent",
        color: enabled ? "var(--beri-accent-hover)" : "var(--beri-text-muted)",
      }}
    >
      <span>🧠</span>
      ...
      <span
        ...
        style={{
          background: enabled ? "var(--beri-accent)" : "var(--beri-border)",
        }}
      >
        <span
          className={`
